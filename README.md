Evolving sample weights for a given dataset and machine learning model using a Genetic Algorithm implemented in Python. Currently supports both lexicase and NSGA-II as parent selection methods.
