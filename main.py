...
def main():
    ...
    datasets_binary = ['heart_disease', 'student_math', 'student_por', 'creditg', 'titanic', 'us_crime', 'compas_violent', 'nlsy', 'compas', 'law_school', 'pmad_phq', 'pmad_epds', 'pmad_rus_phq', 'pmad_rus_epds']
    ...
    #experimental_setup.compare_partial_and_full_dataset_evolved_weights(
